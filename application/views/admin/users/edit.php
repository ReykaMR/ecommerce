    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="role" name="role" required>
                ...
                <option value="customer" <?php echo set_value('role', $user->role) == 'customer' ? 'selected' : ''; ?>>
                    Customer</option>
                <option value="admin" <?php echo set_value('role', $user->role) == 'admin' ? 'selected' : ''; ?>>Admin
                </option>
            </select>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control"
                value="<?php echo date('F d, Y H:i', strtotime($user->created_at)); ?>" readonly>
        </div>
