...
<div class="card">
    ...
    <div class="card-body">
        <?php echo form_open('admin/categories/edit/' . $category->category_id); ?>
        <div class="mb-3">
            <label for="category_name" class="form-label">Category Name *</label>
            <input type="text" class="form-control" id="category_name" name="category_name"
                value="<?php echo set_value('category_name', $category->category_name); ?>" required>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description" name="description"
                rows="3"><?php echo set_value('description', $category->description); ?></textarea>
